...
public class AttentionController {
    ...
    @Operation(summary = "Registrar una atención médica",
            description = "Guarda una nueva atención médica vinculada a una cita ya existente.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> addAttention(@PathVariable UUID id_appointment, @RequestBody AttentionResponseDTO attentionDTO)
    ...
    @Operation(summary = "Eliminar una atención médica",
            description = "Marca como eliminada una atención médica por su ID.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Atención eliminada correctamente",
                    content = @Content(schema = @Schema(implementation = SuccessMessage.class))),
    ...
    @Operation(summary = "Listar todas las atenciones médicas",
            description = "Obtiene todas las atenciones registradas en el sistema con paginación.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Listar atenciones por ID del paciente",
            description = "Obtiene todas las atenciones asociadas a un paciente usando su ID.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Atenciones del paciente obtenidas correctamente",
                    content = @Content(schema = @Schema(implementation = SuccessMessage.class)))
    })
    ...
    @Operation(summary = "Listar atenciones por DNI del paciente",
            description = "Obtiene todas las atenciones asociadas a un paciente usando su DNI.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Atenciones del paciente obtenidas correctamente",
                    content = @Content(schema = @Schema(implementation = SuccessMessage.class)))
    })
    ...
    @Operation(summary = "Listar atenciones por ID del doctor",
            description = "Obtiene todas las atenciones realizadas por un doctor usando su ID.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Atenciones del doctor obtenidas correctamente",
                    content = @Content(schema = @Schema(implementation = SuccessMessage.class)))
    })
    ...
    @Operation(summary = "Listar atenciones por CMP del doctor",
            description = "Obtiene todas las atenciones realizadas por un doctor usando su CMP.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Atenciones del doctor (por CMP) obtenidas correctamente",
                    content = @Content(schema = @Schema(implementation = SuccessMessage.class)))
    })
