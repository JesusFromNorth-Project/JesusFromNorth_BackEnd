...
public class SpecialtyController {
    ...
    @Operation(summary = "Guardar especialidad",
            description = "Guarda una nueva especialidad en el sistema.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Especialidad guardada exitosamente",
    ...
    @Operation(summary = "Listar todas las especialidades",
            description = "Devuelve todas las especialidades registradas en el sistema.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Obtener especialidad con servicios por ID",
            description = "Devuelve una especialidad junto a sus servicios asociados mediante el ID.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Buscar especialidad por nombre",
            description = "Busca una especialidad y sus servicios mediante el nombre.")
    @ApiResponses(value = {
