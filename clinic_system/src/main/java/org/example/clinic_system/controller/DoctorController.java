...
public class DoctorController {
	...
	@Operation(summary = "Crear doctor con usuario y contraseña personalizados", description = "Crea un doctor asignando un administrador (extraído del token) y una especialidad, con username y contraseña definidos por el usuario.")
	@ApiResponses(value = {
	...
	@Operation(summary = "Crear doctor con DNI como usuario", description = "Crea un doctor asignando un administrador (extraído del token) y una especialidad. El DNI será usado como username y password.")
	@ApiResponses(value = {
	...
	public ResponseEntity<?> saveDoctor(
			...
			@RequestHeader("Authorization") String authorizationHeader,
			@PathVariable("specialistId") UUID specialistId) throws NotFoundException {
		Tuple<DoctorResponseDTO, UUID> response = doctorService
				.SaveDoctorWithoutUsername(registerDoctorNoUsernameDTO, adminId, specialistId);
